...
class Bandit2D:
    def __init__(self, c: float):
        """Class representing a 'bandit' that holds score data for a two-dimensional stat (an ordered pair), to be used in the model for the N-Tuple Bandit Online Evolution algorithm used"""
